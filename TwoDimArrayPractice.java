...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    // Write your code here:
		...
		int RLength=intArray.length;
		int CLength=intArray[0].length;
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   int Csize=intArray[row].length;
		
		for (int x=0; x<Csize; x++) 
		{
			intArray[row][x]=value;
			animate(row, x);
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
		...
		int Rsize= intArray.length;
		int minimum=100;
	
		
		for (int x=0;x<Rsize;x++) {
			
			if (intArray[x][column]<minimum) {
				minimum=intArray[x][column];
   ...
   */
   public int countFound( int value )
   {
    ...
    // Write your code here:
		...
		int Lrow=intArray.length;
		int Lc=intArray[0].length;
		int count=0;
